...
public class AerosolParticleRadius extends AppCompatActivity {
    WorldWindow wwd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Aerosol Particle Radius");


        // Create a WorldWindow (a GLSurfaceView)...
        wwd = new WorldWindow(AerosolParticleRadius.this);
// ... and add some map layers
        ...
        layerFactory.createFromWms(
                ...
                "MODAL2_M_AER_OD",                         // WMS layer name
